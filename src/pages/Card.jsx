  ...
  return (
    <div className="container mx-auto">
      <div className="flex items-center justify-center flex-wrap gap-5 mb-10">
        <div className="flex flex-col bg-white p-5 border border-black px-20 rounded-lg">
        ...
        <div className="flex flex-col px-20 bg-white p-5 border border-black  rounded-lg">
